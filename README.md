...
![.NET Framework](https://img.shields.io/badge/.NET%20Framework-4.8-512BD4?style=flat-square)

一个基于 **Microsoft WebView2 (Chromium)** 内核，使用 **C#** 打造的轻量级、现代化、极简风格浏览器。<br>
理论上支持Windows7及更新系统（支持使用.NET Framework4.8的系统）
